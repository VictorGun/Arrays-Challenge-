...
struct ContentView: View {
    ...
    @State private var myFavoriteMovies : [String]? = ["Bird Box", "Cars", "United 93", "Star Wars", "Walle"]
    ...
    var body: some View {
        VStack {
            ...
            if mvpCheck {
                ...
                if s1Check == 0 {
                    Button("Test Stretch 1") {
                        ...
                        if var myFavoriteMovies = myFavoriteMovies {
                             ...
                             *  .  Insert another (new) movie into the fourth position in the list.
                             ************************************/
                            myFavoriteMovies[1] = "Forrest Gump"
                            myFavoriteMovies.append("Avengers 1")
                            myFavoriteMovies.insert("Jurassic Park", at: 2)
                            /*********************************
                             * End of Stretch 1
                             ***********************************/
                    ...
                    Text("Stretch 1 is incorrect, try again")
                }
                else {
                    Text("Stretch 1 is correct")
                    if s2Check == 0 {
                        ...
                        Text("Stretch 2 is incorrect, try again")
                            .padding()
                    }
                    else {
                        Text("Stretch 2 is correct")
                            .padding()
                    }
                    Spacer()
                }
                ...
                Text("MVP is incorrect, try again")
            }
        }
